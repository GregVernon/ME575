...
%% Main Function
% This function is the outer function that executes a differential
% evolution algorithm.
...
%% Create the next generation using differential evolution
...
%% Function Evaluation -- Execute FEA Workflow
...
%% Plot the current parents and write frame to video
